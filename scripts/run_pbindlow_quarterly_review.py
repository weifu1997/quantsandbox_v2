...
REVIEW_SCRIPT = PROJECT_ROOT / 'scripts' / 'run_pbindlow_candidate_review.py'
STATUS_SCRIPT = PROJECT_ROOT / 'scripts' / 'build_pbindlow_candidate_pool_status.py'
...
def main() -> None:
    parser = argparse.ArgumentParser(description='Run candidate review and rebuild pool status in one command')
    ...
    print('candidate review + pool status refresh completed')
