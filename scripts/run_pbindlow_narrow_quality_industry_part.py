...
def run_window(window_label: str) -> Path:
    ...
    if hold_df.empty:
        out = {"window_label": window_label, "industry_counts_top10": {}, "top3_industry_share_mean": 0.0, "avg_industry_count_per_rebalance": 0.0, "rebalance_count": 0}
    else:
    ...
    out_path = OUT_DIR / f"quality_industry_{window_label}.json"
