...
export interface StrategyLineAllocatorReport {
  allocator_status?: AllocatorStatus | null
  portfolio_constraints?: Record<string, unknown> | null
  deployability_consumed?: Record<string, unknown> | null
}
